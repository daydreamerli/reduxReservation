...
function App() {
  ...
  const handleReservations = () => {
    ...
    // use dispatch to trigger the specific actions as redux need use dispatch to trigger actions to change state 
    ...
    <div className="App">
      <div className="container">
        <div className="reservation-container">
          <div>
            <h2 className="reservation-header">Reservations</h2>
